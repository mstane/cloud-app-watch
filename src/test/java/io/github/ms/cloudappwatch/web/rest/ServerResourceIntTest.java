...
public class ServerResourceIntTest {
    ...
    public void getAllServersByLastCheckIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the serverList where lastCheck greater than or equals to DEFAULT_LAST_CHECK
        defaultServerShouldBeFound("lastCheck.greaterOrEqualThan=" + DEFAULT_LAST_CHECK);

        // Get all the serverList where lastCheck greater than or equals to UPDATED_LAST_CHECK
        defaultServerShouldNotBeFound("lastCheck.greaterOrEqualThan=" + UPDATED_LAST_CHECK);
    }
    ...
    public void getAllServersByLastCheckIsLessThanSomething() throws Exception {
        ...
        // Get all the serverList where lastCheck less than or equals to DEFAULT_LAST_CHECK
        defaultServerShouldNotBeFound("lastCheck.lessThan=" + DEFAULT_LAST_CHECK);

        // Get all the serverList where lastCheck less than or equals to UPDATED_LAST_CHECK
    ...
    public void getAllServersByAdminIsEqualToSomething() throws Exception {
        // Initialize the database
        User admin = UserResourceIntTest.createEntity(em);
        em.persist(admin);
        em.flush();
