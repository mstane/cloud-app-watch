...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("cloudappwatch");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("cloudappwatch");
        ...
        config.getMapConfigs().put("io.github.ms.cloudappwatch.domain.*", initializeDomainMapConfig(jHipsterProperties));
